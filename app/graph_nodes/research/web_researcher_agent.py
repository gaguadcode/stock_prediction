...
class ResearcherNode:
    ...
    def extract_topic(self, user_input: str) -> str:
        ...
        try:
            ...
            if response.lower() == "none" or not response:
                logger.warning("⚠️ No relevant Wikipedia topic found.")
                return None
    ...
    def fetch_wikipedia_data(self, topic: str) -> str:
        ...
        if not topic:
            ...
            return "⚠️ No specific Wikipedia topic found, proceeding with general reasoning."
        ...
        try:
            ...
            if docs:
                ...
                summary = "⚠️ No Wikipedia page found."
                logger.warning("⚠️ No Wikipedia page found for the topic.")
    ...
    def researcher(self, state: WorkflowState) -> WorkflowState:
        """
        Executes the researcher node workflow.
        Updates only `None` values in WorkflowState.
        """
        user_input_str = state.user_input  # Extract the raw string
        ...
        updated_data = {
            "research_output": research_summary if state.research_output is None else state.research_output
        }
