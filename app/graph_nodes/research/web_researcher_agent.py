...
from app.graph_nodes.stock.model_training import GradientBoostingWorkflow  # Import Gradient Boosting Workflow
from app.graph_nodes.stock.stock_fetch_data import HistoricalDataFetcher  # Import the HistoricalDataFetcher
